<template>
  <div
    ...
    :class="theme">
    <header class="border-t-14 co">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/">
            <g-image src="../../static/method-draw-image.svg" class="w-40" alt="logo" />
          </g-link>
          <g-link v-else to="/">
            <g-image src="../../static/method-draw-image.svg" class="w-40" alt="logo" />
          </g-link>
        ...
        <ul
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'"
              class="text-copy-primary hover:text-gray-600">Projets</a>
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#contact" v-scroll-to="'#contact'"
              class="text-copy-primary hover:text-gray-600">Contact</a>
    ...
    <footer class="bg-green-700 bgco text-white co">
